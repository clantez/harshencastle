...
{	
	...
	public ModelHarshenSoul(float modelSize)
	{
		...
		this.bipedLeftArm = newRender(4, 5, 4, 5, 2, 0, -1, -2, -2, 56, 10, false, this);
		render(leftArmParts, 4, 5, 4, 5, 2, 0, -1, 5, -2, 40, 10, false);
		render(leftArmParts, 1, 2, 2, 5, 2, 0, 0, 3, -1, 122, 5, false);
		render(leftArmParts, 1, 2, 1, 5, 2, 0, 1, 3, -1, 122, 9, false);
