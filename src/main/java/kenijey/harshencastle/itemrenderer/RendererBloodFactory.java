...
public class RendererBloodFactory extends TileEntitySpecialRenderer<TileEntityBloodFactory>
{
	...
	@Override
	public void render(TileEntityBloodFactory te, double x, double y, double z, float partialTicks,
