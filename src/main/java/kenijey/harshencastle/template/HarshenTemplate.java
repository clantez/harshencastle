...
public class HarshenTemplate 
{
    ...
    protected final List<Template.BlockInfo> blocks = Lists.<Template.BlockInfo>newArrayList();
    ...
    public static HarshenTemplate getTemplate(ResourceLocation location)
    {
    	if(templateMap.containsKey(location))
    		return templateMap.get(location);
    	HarshenTemplate renderer = new HarshenTemplate(location);
