...
/**
 * The main Registry Interface thats passed into custom classes to be used to register pretty much everything harshencastle related.
 * @author Wyn Price
 *
 */
...
{
	/**
	 * Used to register a custom ritual recipe. This recipe will be automatically be added to JEI and into game. 
	 ...
	 */
	void registerRitualRecipe(ItemStack output, boolean useLightning, HarshenStack input1, HarshenStack input2, HarshenStack input3, HarshenStack input4);
	...
	/**
	 * Registers a more advance item that can go into the harshencastle custom inventory
