...
public class PontusWorldGatePart2 extends Item
{
	public PontusWorldGatePart2()
	{
		setUnlocalizedName("pontus_world_gate_part_2");
		setRegistryName("pontus_world_gate_part_2");
