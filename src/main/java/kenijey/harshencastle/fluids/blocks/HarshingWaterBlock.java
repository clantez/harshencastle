...
public class HarshingWaterBlock extends BlockFluidClassic
{
    public HarshingWaterBlock(Fluid fluid)
    {
...
//        			
//        		worldIn.setBlockState(pos.offset(enumfacing).add(0, -1, 0), HarshenBlocks.harshen_dimensional_rock.getDefaultState(), 3);
        ...
        if (flag)
        {
            ...
            {
                worldIn.setBlockState(pos, HarshenBlocks.harshen_dimensional_rock.getDefaultState(), 3);
                return true;
            }
