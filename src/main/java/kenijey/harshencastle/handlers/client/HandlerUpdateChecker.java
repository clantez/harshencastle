...
public class HandlerUpdateChecker 
{
	...
	public void onPlayerTick(PlayerTickEvent event)
	{
		if(!hasPosted)
		{
			...
			try
			{
				URL url = new URL(HarshenCastle.UPDATE_URL);
				con = url.openStream();
	        ...
	        ComparableVersion current = new ComparableVersion(HarshenCastle.VERSION);
	        if (rec != null)
	        {
	        ...
	        {
	        	ITextComponent componant = new TextComponentTranslation("update.version", HarshenCastle.MODNAME, HarshenCastle.VERSION, target)
