...
public class HarshenRecipes {
	...
	public static void register()
	{
		...
		CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.RITUAL_CRYSTAL, 1, 0), new ItemStack(HarshenItems.RITUAL_CRYSTAL, 1, 1), EnumGlassContainer.BLOOD);
		CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.HARSHEN_SOUL_INGOT, 1, 0), new ItemStack(HarshenItems.SOUL_INFUSED_INGOT, 1, 0), EnumGlassContainer.HARSHING_WATER);
		CauldronRecipes.addRecipe(new HarshenStack(Blocks.SAND, 1, 0), new ItemStack(Blocks.SOUL_SAND, 1, 0), EnumGlassContainer.HARSHEN_DIMENSIONAL_FLUID);
		CauldronRecipes.addRecipe(new HarshenStack(Blocks.COBBLESTONE, 1, 0), new ItemStack(Blocks.NETHERRACK, 1, 0), EnumGlassContainer.BLOOD);
		CauldronRecipes.addRecipe(new HarshenStack(Blocks.COBBLESTONE), new ItemStack(Blocks.OBSIDIAN, 2), EnumGlassContainer.LAVA);
		CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.GLASS_CONTAINER), new ItemStack(HarshenItems.GLASS_CONTAINER, 1, 3), EnumGlassContainer.MILK);
		CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.GLASS_CONTAINER), new ItemStack(HarshenItems.GLASS_CONTAINER, 1, 2), EnumGlassContainer.BLOOD);
		CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.EMPTY_RING), new ItemStack(HarshenItems.RING_OF_BLOOD), EnumGlassContainer.BLOOD);
		...
		for(EnumGlassContainer glass : EnumGlassContainer.values())
			if(HarshenUtils.glassContainerHasState(glass))
			{
				...
				{
					CauldronRecipes.addRecipe(new HarshenStack(block), ItemLiquidTypeset.getStackFromType(glass.getType()), EnumGlassContainer.WATER);
					CauldronRecipes.addRecipe(new HarshenStack(HarshenItems.SOLIDIFYING_PASTE), new ItemStack(Item.getItemFromBlock(block)), glass);
				}
				if(!hasInit)
				{
